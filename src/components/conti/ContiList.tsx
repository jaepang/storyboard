  ...
  if (contis.length === 0) {
    return (
      <div className="glass-card p-12 text-center">
        <svg
          className="mx-auto h-12 w-12 text-white/30 mb-4"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <h3 className="text-lg font-medium text-white mb-2">콘티가 없습니다</h3>
        <p className="text-white/60 mb-4">새로운 콘티를 생성해보세요.</p>
      </div>
    );
  }
